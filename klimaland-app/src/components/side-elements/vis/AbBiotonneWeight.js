  ...
  return (
    ...
    >
      ...
      <div className="description">
        <div className="title">
          <h3>
            <span>{lastYear}</span> wurden in <span>{lkData}</span> <span>{lastValue}</span>{' '}
            Millionen tonnen organische Abfälle aus der{' '}
            <span className="first-value">Biotonne</span> und{' '}
            <span className="second-value">Garten- und Parkabfällen</span> entsorgt
          </h3>
        </div>
      </div>
    </div>
